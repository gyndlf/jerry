...
MUTATION_RATE = 0.01  # % of weights the get a small mutation (How common)
MUTATION_SIZE = 0.75  # How big the mutations are. (Standard deviation)

LAYER_PROBA = 0.001  # Chance for a new layer to be added
NODE_PROBA = 0.03  # Chance for a node to be added (or removed)
